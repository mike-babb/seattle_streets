...
<img src="./graphics/ex_19_galer_v3.png" alt="galer" width="1000" height="136"/>

[SEE THIS PAGE FOR v3.0 OF AN INTERACTIVE MAP OF THE ADDED STREETS](https://mike-babb.github.io/media/discontinuous_streets/discontinuous_streets_v3.html)  
...
# The technique
The majority of the work carried out to the find discontinuities in Seattle streets is accomplished across four Jupyter notebooks (steps 01 through 04) with the ten remaining notebooks containing additional data formatting and analyses.
...
* 2,455 uniquely named roads in the study area | 1,890 road miles: see these graphics for a comparison of [miles](/graphics/barplot_miles.png) and [road segments](/graphics/barplot_segment_count.png)  
...
├── README.md - This file  
├── code  
│   ├── [color_list.txt](/code/color_list.txt) - file featuring the html codes for the colors used throughout this project.  
│   ├── [run_constants.py](/code/run_constants.py) - file paths used throughout the notebooks.  
│   ├── [step_01_import_export_street_data.ipynb](/code/step_01_import_export_street_data.ipynb) - import data and perform minimal formatting.  
│   ├── [step_02_export_nodes_seattle_streets.ipynb](/code/step_02_export_nodes_seattle_streets.ipynb) - curate the set of working streets, create the city sectors.  
│   ├── [step_03_merge_data.ipynb](/code/step_03_merge_data.ipynb) - merge data generated in steps 07 and 08.  
│   ├── [step_04_find_discontinuities.ipynb](/code/step_04_find_discontinuities.ipynb) - use NetworkX to identify discontinuities and create the added segments.  
│   ├── [step_05_prepare_graphs_and_stats.ipynb](/code/step_05_prepare_graphs_and_stats.ipynb) - conduct analyses on the added segments.  
│   ├── [step_06_draw_an_nx_graph.ipynb](/code/step_06_draw_an_nx_graph.ipynb) - plot a NetworkX graph object of Galer. The plot changes every time the code is run.  
│   ├── [step_07_format_data_for_v2_plot_single_streets.ipynb](/code/step_07_format_data_for_v2_plot_single_streets.ipynb) - generate plots of individual streets for manual review.  
│   ├── [step_08_format_data_for_v2_plot_street_groups.ipynb](/code/step_08_format_data_for_v2_plot_street_groups.ipynb) - generate plots of groups of streets of manual review.  
│   ├── [step_09_compare_edge_differences.ipynb](/code/step_09_compare_edge_differences.ipynb) - compare differences between the added segments in v1 and v2.  
│   ├── [step_10_update_central_streets.ipynb](/code/step_10_update_central_streets.ipynb) - curate the list of streets in the central business district.  
│   ├── [step_11_prep_for_webmap.ipynb](/code/step_11_prep_for_webmap.ipynb) - create non-overlapping polygons and inner ring buffers and export data for use in a webmap.  
│   ├── [step_12_calculate_angle_differences.ipynb](/code/step_12_calculate_angle_differences.ipynb) - demonstrate how to plot angle vertices in polar coordinates.  
│   ├── [step_13_find_overlapping_segments.ipynb](/code/step_13_find_overlapping_segments.ipynb) - code to find the overlapping street segments.  
│   ├── [step_14_prep_for_webmap_v3.ipynb](/code/step_14_prep_for_webmap_v3.ipynb) - export the data for the version 3.0 of the webmap
│   └── [utils.py](/code/utils.py) - functions used throughout the notebooks.  
├── data  
│   ├── [Seattle_City_Limits_3136622578314448116.gpkg](/data/Seattle_City_Limits_3136622578314448116.gpkg) - Seattle City Limits downloaded from the City of Seattle. Only used in the qGIS map.  
│   ├── [Street_Network_Database_SND_5117857036965774451.gpkg](/data/Street_Network_Database_SND_5117857036965774451.gpkg) - Street Network downloaded from the City of Seattle. This is the starting file.    
│   ├── [blank_street_type_working.xlsx](/data/blank_street_type_working.xlsx) - Roads with a manually created classifications. Used to ensure that every road has a classification (AVE, WAY, PL, for example.)  
│   ├── [city_sector.csv](/data/city_sector.csv) - list of SND and corresponding city sector.  
│   ├── [city_sector_check_working.xlsx](/data/city_sector_check_working.xlsx) - list of combined city sectors and a manually updated sort order of the combination.  
│   ├── [state_name.csv](/data/state_name.csv) - list of state names, used in a trivial analysis in Step 07.  
│   ├── [street_groups_working.xlsx](/data/street_groups_working.xlsx) - list of streets and manually curated street groups.  
│   ├── [streets_to_remove.txt](/data/streets_to_remove.txt) - a list (1, as of 2025/2/23) of short segments from the original data that can be removed. This is most likely an erroneous data artifact inadvertently left in during data processing by the City of Seattle. These were discovered by panning around a qGIS map visually identifying oddities. I have no doubt there are more to discover. In step 02, this file can be loaded and used to remove the erroneous segments. In v1, there were a lot more of these stubby segments. In v2, I set the `segment_type = 1` and removed all of the stubby streets as well.  
│   └── [toss_snd.csv](/data/toss_snd.csv) - additional street segments that can be removed from processing, used in step 10.  
├── graphics  
│   ├── [barplot_miles.png](/graphics/barplot_miles.png) - barplot of the total miles by road type and road status.  
│   ├── [barplot_segment_count.png](/graphics/barplot_segment_count.png) - barplot of the total number of segments by road type and road status.  
│   ├── [ex_01_galer.png](/graphics/ex_01_galer.png) - v1 street segments added to GALER ST.  
│   ├── [ex_02_overall.png](/graphics/ex_02_overall.png) - v1 street segments added across the City of Seattle.  
│   ├── [ex_03_north_capitol_hill.png](/graphics/ex_03_north_capitol_hill.png) - v1 street segments added in north Capitol Hill.  
│   ├── [ex_04_most_added_segments.png](/graphics/ex_04_most_added_segments.png) - v1 streets with the most added segments.  
│   ├── [ex_05_longest_added_segments.png](/graphics/ex_05_longest_added_segments.png) - v1 street with the longest added segments.  
│   ├── [ex_06_shortest_segment.png](/graphics/ex_06_shortest_segment.png) - screenshot of the shortest added segment.  
│   ├── [ex_07_51.png](/graphics/ex_07_51.png) - v1 street segments added for all roads named 51st.  
│   ├── [ex_08_15th_ave_w.png](/graphics/ex_08_15th_ave_w.png) - erroneous segments on 15th AVE W.  
│   ├── [ex_09_sw_florida_st.png](/graphics/ex_09_sw_florida_st.png) - erroneous segments on SW FLORIDA ST.  
│   ├── [ex_10_woodlawn_ave_n.png](/graphics/ex_10_woodlawn_ave_n.png) - v1 connectivity for WOODLAWN.  
│   ├── [ex_11_galer_v2.png](/graphics/ex_11_galer_v2.png) - v2 connectivity for GALER.  
│   ├── [ex_12_overall_v2.png](/graphics/ex_12_overall_v2.png) - v2 overall connectivity.  
│   ├── [ex_13_north_capitol_hill_v2.png](/graphics/ex_13_north_capitol_hill_v2.png) - v2 connectivity for north Capitol Hill.  
│   ├── [ex_14_most_added_segments_v2.png](/graphics/ex_14_most_added_segments_v2.png) - v2 connectivity for streets with the most added segments.  
│   ├── [ex_15_longest_added_segments_v2.png](/graphics/ex_15_longest_added_segments_v2.png) - v2 connectivity for streets with the longest added segments.  
│   ├── [ex_16_10th_ave.png](/graphics/ex_16_10th_ave.png) - v2 connectivity for 10TH AVE.  
│   ├── [ex_17_9th_ave.png](/graphics/ex_17_9th_ave.png) - v2 connectivity for 9TH AVE.  
│   ├── [ex_18_nebraska_st.png](/graphics/ex_18_nebraska_st.png) - v2 connectivity for NEBRASKA ST.  
│   ├── [ex_19_galer_v3.png](/graphics/ex_19_galer_v3.png) - v3 street segments added to GALER ST.  
│   ├── [ex_20_overall_v3.png](/graphics/ex_20_overall_v3.png) - v3 street segments added across the City of Seattle.  
│   ├── [ex_21_north_capitol_hill_v3_WS.png](/graphics/ex_21_north_capitol_hill_v3_WS.png) - v3 within sector street segments added in north Capitol Hill.  
│   ├── [ex_22_north_capitol_hill_v3_CS.png](/graphics/ex_22_north_capitol_hill_v3_CS.png) - v3 within sector street segments added in north Capitol Hill.  
│   ├── [ex_23_most_added_segments_v3.png](/graphics/ex_23_most_added_segments_v3.png) - v3 streets with the most added segments.  
│   ├── [ex_24_longest_added_segments_v3.png](/graphics/ex_24_longest_added_segments_v3.png) - v3 street with the longest added segments.  
│   ├── [histogram_cs_ALL_streets.png](/graphics/histogram_cs_ALL_streets.png) - histogram for all cross-sector added segments.  
│   ├── [histogram_cs_AVE.png](/graphics/histogram_cs_AVE.png) - histogram of cross-sector added segments for streets of type AVE (avenue).  
│   ├── [histogram_cs_BLVD.png](/graphics/histogram_cs_BLVD.png) - histogram of cross-sector added segments for streets of type BLVD (boulevard).  
│   ├── [histogram_cs_CT.png](/graphics/histogram_cs_CT.png) - histogram of cross-sector added segments for streets of type CT (court).  
│   ├── [histogram_cs_DR.png](/graphics/histogram_cs_DR.png) - histogram of cross-sector added segments for streets of type DR (drive).  
│   ├── [histogram_cs_RD.png](/graphics/histogram_cs_RD.png) - histogram of cross-sector added segments for streets of type RD (road).  
│   ├── [histogram_cs_ST.png](/graphics/histogram_cs_ST.png) - histogram of cross-sector added segments for streets of type ST (street).  
│   ├── [histogram_cs_WAY.png](/graphics/histogram_cs_WAY.png) - histogram of cross-sector added segments for streets of type WAY (way).  
│   ├── [histogram_ws_ALL_streets.png](/graphics/histogram_ws_ALL_streets.png) - histogram of all within-sector added segments.  
│   ├── [histogram_ws_AVE.png](/graphics/histogram_ws_AVE.png) - histogram of within-sector added segments for streets of type AVE (avenue).  
│   ├── [histogram_ws_ALL_streets_overlapping.png](/graphics/histogram_ws_ALL_streets_overlapping.png) - Histograms of the within-sector added overlapping and non-overlapping segments.  
│   ├── [histogram_ws_BLVD.png](/graphics/histogram_ws_BLVD.png) - histogram of within-sector added segments for streets of type BLVD (boulevard).  
│   ├── [histogram_ws_CT.png](/graphics/histogram_ws_CT.png) - histogram of within-sector added segments for streets of type CT (court).  
│   ├── [histogram_ws_DR.png](/graphics/histogram_ws_DR.png) - histogram of within-sector added segments for streets of type DR (drive).  
│   ├── [histogram_ws_LN.png](/graphics/histogram_ws_LN.png) - histogram of within-sector added segments for streets of type LN (lane).  
│   ├── [histogram_ws_PKWY.png](/graphics/histogram_ws_PKWY.png) - histogram of within-sector added segments for streets of type PKWY (parkway).  
│   ├── [histogram_ws_PL.png](/graphics/histogram_ws_PL.png) - histogram of within-sector added segments for streets of type PL (place).  
│   ├── [histogram_ws_RD.png](/graphics/histogram_ws_RD.png) - histogram of within-sector added segments for streets of type RD (road).  
│   ├── [histogram_ws_ST.png](/graphics/histogram_ws_ST.png) - histogram of within-sector added segments for streets of type ST (street).  
│   ├── [histogram_ws_WAY.png](/graphics/histogram_ws_WAY.png) - histogram of within-sector added segments for streets of type WAY (way).  
│   ├── [scatterplot_existing_added_segment_ratio.png](/graphics/scatterplot_existing_added_segment_ratio.png) - scatter plot of the streets by sector of existing road miles to added road miles.  
│   └── [seattle_sections.png](/graphics/seattle_sections.png) - maps of the sectors in the City of Seattle.  
├── maps  
│   ├── [all_streets_diss_v2.geojson](/maps/all_streets_diss_v2.geojson) - continuous, discontinuous, and added roads in geojson format.  
│   ├── [all_streets_diss_v3.geojson](/maps/all_streets_diss_v3.geojson) - continuous, discontinuous, and added roads in geojson format. Features classified by overlapping and non-overlapping status.  
│   ├── [city_sector_lines.geojson](/maps/city_sector_lines.geojson) - city sector outlines for use in the webmap  
│   ├── [discontinuous_streets_v2.html](/maps/discontinuous_streets_v2.html) - interactive webmap featuring the continuous, discontinuous, and added roads.  
│   ├── [discontinuous_streets_v3.html](/maps/discontinuous_streets_v3.html) - interactive webmap featuring the continuous, discontinuous, and added roads. Features classified by overlapping and non-overlapping status.  
│   ├── [seattle_streets.qgz](/maps/seattle_streets.qgz) - qGIS map showcasing different aspects of the added street types.  
│   └── [street_layer_file.qml](/maps/street_layer_file.qml) - qGIS layer file for easy street symbology  
└── [seattles_disconnected_streets_2024_11_20.pptx](seattles_disconnected_streets_2024_11_20.pptx) - Presentation I gave to the [CUGOS](https://cugos.org/) group on November 20, 2024 showcasing the motivation, findings, limitations and next steps of this project. This presentation encompasses a lot of the work as described in this `README.md` file.  

# Future work
Making v1.0 of this repo publicly available was my first goal. My next two goals are as follows:  
1. ~~Create an interactive webmap to embed the results.~~  
[Click here for v2 of an interactive webmap](https://mike-babb.github.io/media/discontinuous_streets_v3.html)  
