...
![Galer](/graphics/ex_01_galer.png)  
...
![overall](/graphics/ex_02_overall.png)
...
![North Capitol Hill](/graphics/ex_03_north_capitol_hill.png)
...
![histogram of added streets](/graphics/histogram_ALL_street.png)
...
│   ├── ex_03_north_capitol_hill.png - missing street sections added nort Capitol Hill.  
│   ├── histogram_ALL.png - histogram for all roads.  
...
1) Create a webmap to embed in either this repo or a different blog. 
...
![51st](/graphics/ex_04_51.png)  
There are five streets named 51st: NE 51st ST, 51st AVE NE, 51st AVE SW, and 51st AVE S, and 51st PL S. Should 51st AVE S and 51st AVE NE be connected? Perhaps! Upon visual inspection, they align to a quasi-grid. But then, so do most of the streets in Seattle. 
